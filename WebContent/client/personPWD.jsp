	...
	<div style="margin-top: 50px; margin-left: 300px">
		<form action="<%=basePath%>/client/ClientServlet?op=personPassword"
			...
			<div class="form-group">
				...
				<input class="form-control" type="password" id="password" name="password" style="width: 700px">
			</div>
			<div class="form-group">
				<label for="exampleInputEmail1">确认密码：</label> 
				<input onblur="confirmP()" class="form-control" type="password" id="repassword" name="repassword" style="width: 700px">
			</div>
			<br>
